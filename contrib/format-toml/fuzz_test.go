// Fuzzing for the format-toml parser.
package toml_test
...
// FuzzTomlNeverPanics feeds arbitrary bytes to the parser.
//
...
// finding.
func FuzzTomlNeverPanics(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, doc []byte) {
		...
		_, _, _ = cfgkit.Load[cfg](cfgkit.WithSources(tomlsrc.Source("fuzz.toml", doc)))
	})
}
