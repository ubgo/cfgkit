...
import (
	...
	etcdsrc "github.com/ubgo/cfgkit/contrib/source-etcd"
)
...
// FuzzEtcdResponseNeverPanics serves arbitrary bytes as the response body.
func FuzzEtcdResponseNeverPanics(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, body []byte) {
		...
		_, _, _ = cfgkit.Load[fuzzCfg](cfgkit.WithSources(etcdsrc.Prefix("app/", etcdsrc.WithAddress(srv.URL))))
	})
}
