...
import (
	...
	vaultsrc "github.com/ubgo/cfgkit/contrib/source-vault"
)
...
// FuzzVaultResponseNeverPanics serves arbitrary bytes as the response body.
func FuzzVaultResponseNeverPanics(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, body []byte) {
		...
		_, _, _ = cfgkit.Load[fuzzCfg](cfgkit.WithSources(vaultsrc.Secret("app/config", vaultsrc.WithAddress(srv.URL), vaultsrc.WithToken("t"))))
	})
}
