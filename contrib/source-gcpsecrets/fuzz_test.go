...
import (
	...
	gcpsrc "github.com/ubgo/cfgkit/contrib/source-gcpsecrets"
)
...
// FuzzGCPResponseNeverPanics serves arbitrary bytes as the response body.
func FuzzGCPResponseNeverPanics(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, body []byte) {
		...
		_, _, _ = cfgkit.Load[fuzzCfg](cfgkit.WithSources(gcpsrc.Secret("s", "HOST", gcpsrc.WithProject("p"), gcpsrc.WithToken("t"), gcpsrc.WithEndpoints(srv.URL, srv.URL))))
	})
}
