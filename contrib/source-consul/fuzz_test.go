...
import (
	...
	consulsrc "github.com/ubgo/cfgkit/contrib/source-consul"
)
...
// FuzzConsulResponseNeverPanics serves arbitrary bytes as the response body.
func FuzzConsulResponseNeverPanics(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, body []byte) {
		...
		_, _, _ = cfgkit.Load[fuzzCfg](cfgkit.WithSources(consulsrc.Prefix("app/", consulsrc.WithAddress(srv.URL))))
	})
}
