// Fuzzing for the format-properties parser.
...
// FuzzPropertiesNeverPanics feeds arbitrary bytes to the parser.
//
...
// finding.
func FuzzPropertiesNeverPanics(f *testing.F) {
	...
	f.Fuzz(func(t *testing.T, doc []byte) {
		...
		_, _, _ = cfgkit.Load[cfg](cfgkit.WithSources(propsrc.Source("fuzz.properties", doc)))
	})
}
